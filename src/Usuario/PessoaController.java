...
public class PessoaController {
	...
	@GetMapping("/pessoas")
	CollectionModel<EntityModel<Pessoa>> all() {

	  List<EntityModel<Pessoa>> pessoas = repository.findAll().stream()
	      .map(pessoa -> EntityModel.of(pessoa,
	  ...
	  return CollectionModel.of(pessoas, linkTo(methodOn(PessoaController.class).all()).withSelfRel());
	}
	...
	/*
	 * @GetMapping("/pessoas/{id}") Pessoa one(@PathVariable Long id) {
	 * 
